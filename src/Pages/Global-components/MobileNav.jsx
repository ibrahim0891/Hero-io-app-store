...
const MobileNav = () => {
    ...
    return (
        <nav className='w-full sm:w-2/3  fixed bottom-0 sm:left-1/2 sm:-translate-x-1/2 px-4 py-2'>
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) =>
                               ...
                               hover:bg-white/50 hover:rounded-full hover:py-3 hover:px-4
                                ${isActive
                                    ? "bg-white rounded-full w-full py-3 px-4 border border-gray-200 "
                                    : "w-full py-3 border-0"
                                } `
                            }
                        >
                            <span>{nav.icon}</span>
